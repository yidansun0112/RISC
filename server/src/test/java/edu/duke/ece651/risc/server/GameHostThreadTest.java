...
public class GameHostThreadTest {
  ...
  private GameHostThread<String> createGameHostThread(int num) {
    ...
    OrderRuleChecker<String> moveChecker=new MoveOrderConsistencyChecker<String>(new MoveOrderPathChecker<String>(new MoveOrderEffectChecker<String>(null)));
    OrderRuleChecker<String> attackChecker=new AttackOrderConsistencyChecker<String>(new AttackOrderPathChecker<String>(new AttackOrderEffectChecker<String>(null)));
    CyclicBarrier barrier = new CyclicBarrier(num + 1);
    return new GameHostThread<String>(playerMock, Constant.TOTAL_UNITS, board, view, moveChecker, attackChecker, barrier);
  }
