...
public class V2MoveOrderConsistencyCheckerTest {
  ...
  public void test_V2MoveOrderConsistencyCheckerTest() {
    ...
    GUIPlayerEntity<String> p = new GUIPlayerEntity<String>(null, null, 0, "lzy", 0,
    ...
    String s3 = "You cannot move to the same place.\n";
    Order<String> o3 = new V2MoveOrder<>(0, 0, new HashMap<Integer, Integer>());
    assertEquals(s3, checker.checkMyRule(0, o3, new GameStatus<String>(p, b, false)));
  }
