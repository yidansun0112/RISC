...
public class V2UpgradeTechLevelOrderTest {
  @Test
  public void test_V2UpgradeTechLevelOrderTest() {
    ...
    assertEquals(-1, o1.getSrcTerritory());
    assertEquals(-1, o1.getDestTerritory());
    assertEquals(-1, o1.getUnitAmount());
    assertEquals(false, o1.execute(b));
    assertEquals(null, o1.getArmyHashMap());
  }
